            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">User Trying To Contact You</h4>
                  <p class="card-category"> **Data Updated</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <?php
$sql="SELECT * from contact ORDER BY CAST(`id` AS UNSIGNED) DESC";
...
{               ?>
                      <tbody>
                        <tr>
                          ...
                          <td><?php  echo htmlentities($row->full_message);?></td>
