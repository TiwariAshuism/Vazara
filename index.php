...
<html lang="en">
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="100">
      ...
      >
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li>
              <a class="nav-link scrollto" href="Categories">Categories</a>
            </li>
            <li>
            ...
            <li>
              <a class="nav-link scrollto" href="assets/Vazara Frenchise.pdf"
                download>Broucher</a
              >
            </li>
            <li>
      ...
      >
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="10000">
            <img
              src="assets/img/main-banner2.jpg"
              class="d-block w-100"
              alt="..."
            />
          </div>
          <div class="carousel-item" data-bs-interval="2000">
            <img
              src="assets/img/main-banner1.jpg"
              class="d-block w-100"
              alt="..."
            />
          </div>
          ...
          <div class="carousel-item">
            <img
              src="assets/img/main-banner3.jpg"
              class="d-block w-100"
              alt="..."
            />
          </div>
          <div class="carousel-item">
            <img
              src="assets/img/main-banner4.jpg"
              class="d-block w-100"
              alt="..."
            />
          </div>
    ...
    <!-- End Hero -->
    <header class="section-header" id="about"><p>About Us</p></header>
    <main id="main">
      <!-- ======= About Section ======= -->
      <section class="about">
          ...
          <div class="row gx-0">
            ...
            >
              <div class="content">
                <h3>Who We Are</h3>
                <h2>
                  Vazara is a online supermarket chain that aims to offer
      ...
      <section id="values" class="values">
        <div class="container" data-aos="fade-up">
          <header class="section-header"><p>Categories</p></header>
          <div class="row">
            <div class="col-lg-4">
      ...
      <section id="clients" class="clients">
        <div class="container" data-aos="fade-up">
          <header class="section-header"><p>Patners</p></header>
